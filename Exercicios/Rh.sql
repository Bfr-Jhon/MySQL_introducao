...
VALUES	("Pedro", "Marketing", 4560.00, "2023-04-20", "Tarde"),
	    ("Tiago", "Serviços Gerais", 1512.00, "2026-01-03", "Manha"),
	    ("Joao", "Diretora de projetos", 14000.00, "2015-07-13", "Manha"),
	    ("Marcos", "Engenheira de Software", 6780.00, "2022-11-25", "Tarde"),
	    ("Correia", "Segurança", 1800.00, "2020-03-15", "Tarde"),
	    ("Luiz", "Analista de Sistemas", 6118.00, "2024-06-08", "Manha");
